...
! function(t, n) {
    "object" == typeof exports && "undefined" != typeof module ? n(exports) : n(t.d3 = t.d3 || {})
    "object" == typeof exports && "undefined" != typeof module ? n(exports) : n(t.d3 = t.d3 || {})
}(this, function(t) {
    "use strict";
    ...
    function Pr(t, n) {
        ...
        return "undefined" == typeof XDomainRequest || "withCredentials" in s || !/^(http(s)?:)?\/\//.test(t) || (s = new XDomainRequest), "onload" in s ? s.onload = s.onerror = s.ontimeout = e : s.onreadystatechange = function(t) {
            ...
            send: function(n, e, o) {
                return o || "function" != typeof e || (o = e, e = null), o && 1 === o.length && (o = qr(o)), s.open(n, t, !0, f, l), null == i || c.has("accept") || c.set("accept", i + ",*/*"), s.setRequestHeader && c.each(function(t, n) {
    ...
    function Nl() {
        ...
        function e(t, n) {
            return n = Math.max(M, Math.min(T, n)), n === t.k ? t : new ml(n, t.x, t.y)
        }
        ...
        function s() {
            ...
            if (b.apply(this, arguments)) {
                ...
                if (x) {
                    ...
                    if (u.k === c) return;
                    o.extent = w.apply(this, arguments), y = u.invert(_ = du(this)), Ha(this), o.start()
                }
                wl(), x = setTimeout(n, q), o.zoom("mouse", i(r(e(u, c), _, y), o.extent))
            }
        }

        function f() {
            function n() {
                wl(), v = !0, o.zoom("mouse", i(r(o.that.__zoom, _ = du(o.that), y), o.extent))
            }

            function e() {
                u.on("mousemove.zoom mouseup.zoom", null), Cf(t.event.view, v), wl(), o.end()
            }
            if (!m && b.apply(this, arguments)) {
                var o = a(this, arguments),
                    u = Ra(t.event.view).on("mousemove.zoom", n, !0).on("mouseup.zoom", e, !0);
                Ef(t.event.view), bl(), v = !1, o.extent = w.apply(this, arguments), y = this.__zoom.invert(_ = du(this)), Ha(this), o.start()
            }
        }
        ...
        function l() {
            if (b.apply(this, arguments)) {
                ...
                wl(), E > 0 ? Ra(this).transition().duration(E).call(u, f, a) : Ra(this).call(n.transform, f)
            }
        }
        ...
        function h() {
            if (b.apply(this, arguments)) {
                ...
                return g && (g = clearTimeout(g), !i.touch1) ? (i.end(), l.apply(this, arguments)) : void(t.event.touches.length === u && (g = setTimeout(function() {
                    g = null
                }, P), Ha(this), i.extent = w.apply(this, arguments), i.start()))
            }
        }
        ...
        function p() {
            var n, o, u, c, s = a(this, arguments),
                ...
                l = f.length;
            for (wl(), g && (g = clearTimeout(g)), n = 0; n < l; ++n) o = f[n], u = Da(this, f, o.identifier), s.touch0 && s.touch0[2] === o.identifier ? s.touch0[0] = u : s.touch1 && s.touch1[2] === o.identifier && (s.touch1[0] = u);
        ...
        function d() {
            var n, e, r = a(this, arguments),
                ...
                o = i.length;
            for (bl(), m && clearTimeout(m), m = setTimeout(function() {
                m = null
        ...
        return n.transform = function(t, n) {
            ...
            emit: function(t) {
                lu(new gl(n, t, this.that.__zoom), z.apply, z, [t, this.that, this.args])
            }
        }, n.filter = function(t) {
            return arguments.length ? (b = "function" == typeof t ? t : yl(!!t), n) : b
        }, n.extent = function(t) {
            return arguments.length ? (w = "function" == typeof t ? t : yl([
                [+t[0][0], +t[0][1]],
                [+t[1][0], +t[1][1]]
            ]), n) : w
    ...
    function Kp() {
        return Jp(Qp).scale(151).translate([480, 347])
    }
    ...
    function od() {
        return Zp(pw).scale(120).clipAngle(179.999)
    }

    function ud() {
        return Zp(dw).scale(480 / ab).clipAngle(179.999)
    }
    ...
    function sd(t) {
        ...
        return e.scale = function(t) {
            ...
            return o(t), e
        }, e.clipExtent(null).scale(961 / ab)
    }
    ...
    function _d() {
        return Jp(vd).scale(128).translate([480, 280])
    }
    ...
    function gd() {
        return Zp(yd).scale(139).clipAngle(60)
    }
    ...
    function xd() {
        return Zp(md).scale(240).clipAngle(90 + eb)
    }
    ...
    function wd() {
        return Zp(bd).scale(240).clipAngle(142)
    }
